...
public static class ApiManager
{
    ...
    internal static void CheckForUpdates()
    {
        ...
        var currentVersion = SerpentsHand.Singleton.Version;
    ...
    internal static string SendLogsAsync(string content)
    {
        try
        {
            var url = $"{ApiBase}/api/v1/plugin/{Uri.EscapeDataString(SerpentsHand.Singleton.Name)}/log";
            ...
            {
                content,
                plugin_version = SerpentsHand.Singleton.Version.ToString(),
